...
<nav class="bg-white shadow">
  ...
  <div class="flex items-center space-x-2 text-lg font-semibold">
    ...
    <div class="hidden md:flex items-center space-x-8">
      <div class="flex items-center space-x-4">
        ...
        <a href="/admin_registration_requests.php" class="<?= nav_link_classes($isRegistrations) ?>" <?= $isRegistrations ? 'style="' . nav_link_style($isRegistrations) . '"' : '' ?>>Registrations</a>
  ...
  <div id="adminMobileMenu" class="md:hidden hidden border-t border-gray-200">
    <div class="px-4 py-4 space-y-3">
      ...
      <a href="/admin_registration_requests.php" class="block w-full <?= $isRegistrations ? 'text-white' : 'text-gray-700 hover:bg-gray-100' ?> px-3 py-2 rounded" <?= $isRegistrations ? 'style="background-color: #692f69;"' : '' ?>>Registrations</a>
